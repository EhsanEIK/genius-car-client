...
const Services = () => {
    ...
    useEffect(() => {
        fetch(`https://genius-car-server-rouge.vercel.app/services?order=${isAsc ? 'asc' : 'desc'}&priceRange=${lowPrice ? 'low' : 'all'}`)
            .then(res => res.json())
    ...
    return (
        <div className='my-32'>
            ...
            <div className='flex justify-center my-10'>
                ...
                <button className='bg-lime-600 hover:bg-lime-700 text-white rounded-lg ml-3 px-2 py-1' onClick={() => setLowPrice(!lowPrice)}>
